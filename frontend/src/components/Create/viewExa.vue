      ...
      <div v-if="num === index">
        ...
        >
          <div @change="rideoChange">
            <el-radio v-model="allRadio[index]" label="A"
              >A.{{ item.answer1 }}</el-radio
            ><br />
            <el-radio v-model="allRadio[index]" label="B"
              >B.{{ item.answer2 }}</el-radio
            ><br />
            <el-radio v-model="allRadio[index]" label="C"
              >C.{{ item.answer3 }}</el-radio
            ><br />
            <el-radio v-model="allRadio[index]" label="D"
